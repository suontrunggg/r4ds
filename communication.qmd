...
In Chapter 10, plots were used mainly for **exploratory analysis**, where the goal was to quickly examine relationships between variables. During this stage, many plots are created for specific questions and are often discarded after inspection.

However, once you understand the data, the focus shifts to **communicating insights to others**. Since your audience may not share the same background knowledge, plots need to be **clear, informative, and self-explanatory**. This chapter introduces tools in **ggplot2** that help improve the clarity and presentation of visualizations.

The chapter focuses on **how to create effective graphics**, assuming that you already know what you want to show. It is recommended to combine these technical skills with visualization principles from books like *The Truthful Art* by Albert Cairo, which explains how to design meaningful and effective visualizations.
